...
- Remove the Writing as you... headline from the thread answer form;
- Move the remaining characters counter to the bottom of the form, on the left side of the cancel button.
