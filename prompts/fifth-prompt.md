...
- The answer form must have a style similar to the listed answer, that would make it more visually integrated with the answer list, which will bring the sensation that you're actually writing an answer;
- The thread reply button doesn't seem very good the way it is. I want it to have the same style as the thread form submit button, but a bit smaller.
