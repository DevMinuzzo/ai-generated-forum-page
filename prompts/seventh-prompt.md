...
- The mood in a thread in the timeline is not very visible because the background is grayish. I would like to change the background color of the mood container shown in a thread;
- The mood background color should be according to the thread mood. It should go from red to green, depending on the mood and have a yellow background color for the neutral mood (3).
